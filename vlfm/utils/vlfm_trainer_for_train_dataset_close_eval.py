...
class VLFMTrainer(PPOTrainer):
    ...
    def _eval_checkpoint(
        ...
        logger_file_name = "./log_files/log_0.2m_il_train_complete_data_new_weighting_data_train_dataset_for_eval_"+date_time+"_init_170"
        ...
        selected_episodes = selected_episodes[170:]
        # =====> select episodes <=====

...
class VLFMTrainer(PPOTrainer):
    ...
    # pre_policy = 'checkpoints_single_v3_easy_data_softmax/epoch_3.pt'
    ...
    policy_model = HistoryAwareUNet(in_channels=6).to("cuda")
    policy_model.load_state_dict(torch.load("Models_train_PPO/policy/multi_process_sac/29_actor"))
    policy_model.eval()
    ...
    def _eval_checkpoint(
        ...
        # logger_file_name = "./log_files/log_for_q_learning_eval_model_one_utd_sac_model_45_"+date_time
        # logger_file_name = "./log_files/log_for_q_learning_eval_model_softmax_t_il_model_3_new_percept_"+date_time
        logger_file_name = "./log_files/log_for_q_learning_eval_model_one_utd_sac_model_percept_actor_29_improve_"+date_time+"_init_400"
        ...
        while len(stats_episodes)+400 < (number_of_eval_episodes * evals_per_ep) and self.envs.num_envs > 0:

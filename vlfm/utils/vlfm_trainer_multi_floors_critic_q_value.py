...
class VLFMTrainer(PPOTrainer):
    ...
    policy_model.load_state_dict(torch.load("Models_train_PPO/policy/multi_process_sac/1143_critic"))
    policy_model.eval()
    ...
    def _eval_checkpoint(
        ...
        # logger_file_name = "./log_files/log_for_sac_hm3d_v1_IL_all_vision_RL_model_1002_"+date_time+f"_init_{main_args.init_episode}"
        logger_file_name = "./log_files/log_ascent_get_new_critic_q_value_multi_stairs_RL_model_1143_multi_revise"+date_time+f"_init_{main_args.init_episode}"

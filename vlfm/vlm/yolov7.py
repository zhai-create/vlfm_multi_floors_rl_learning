...
class YOLOv7Client:
    # def __init__(self, port: int = 12084):
    def __init__(self, port: int = main_args.yolo_port):
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--port", type=int, default=12084)
    parser.add_argument("--port", type=int, default=main_args.yolo_port)

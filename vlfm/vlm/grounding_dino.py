...
class GroundingDINOClient:
    # def __init__(self, port: int = 12081):
    def __init__(self, port: int = main_args.dino_port):
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--port", type=int, default=12081)
    parser.add_argument("--port", type=int, default=main_args.dino_port)

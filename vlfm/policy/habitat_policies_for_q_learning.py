...
class HabitatMixin:
    ...
    def act(
        ...
        try:
            action, rnn_hidden_states, _done_initializing = parent_cls.act(obs_dict, rnn_hidden_states, prev_actions, masks, deterministic) # 执行BaseObjectNavPolicy中的act
        ...
        if(action is None):
            return None, _done_initializing
        else:

...
class ITMPolicyV2(BaseITMPolicy):
    def act(
        ...
        # self._value_map._value_map = (explored_numeric * self._value_map._value_map.squeeze())[:, :, np.newaxis]
        # observations['value_map'] = self._value_map._value_map   
        ...
        return super().act(need_replan, observations, rnn_hidden_states, prev_actions, masks, deterministic)

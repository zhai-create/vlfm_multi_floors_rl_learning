...
class HabitatMixin:
    ...
    def act(
        ...
        try:
            action, rnn_hidden_states, all_save_dict_ls = parent_cls.act(need_replan, obs_dict, rnn_hidden_states, prev_actions, masks, deterministic) # 执行BaseObjectNavPolicy中的act
